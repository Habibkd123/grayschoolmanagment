    ...
    <main className="w-full">
      ...
      <section className="relative py-28 bg-slate-900">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 text-center">
          <span className="inline-block px-4 py-1.5 bg-white/10 border border-white/20 text-[var(--warning)] font-extrabold text-[12px] font-bold uppercase tracking-widest rounded-sm mb-6">Athletic Program</span>
          <h1 className="text-5xl md:text-6xl  font-bold text-white font-sans font-black leading-tight">Sports & Athletics</h1>
        </div>
      </section>
