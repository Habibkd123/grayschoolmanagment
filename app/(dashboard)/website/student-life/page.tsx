    ...
    <div className="space-y-6 max-w-4xl">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div className="w-10 h-10 rounded-xl bg-[var(--primary)]/10 border border-[var(--primary)]/20 flex items-center justify-center"><Trophy className="w-5 h-5 text-[var(--primary)]" /></div>
          <div>
      ...
      <div className="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-6 space-y-5">
        ...
        {data.achievements.length === 0 ? (
          <p className="text-slate-600 dark:text-slate-500 text-[13px] text-center py-4">No achievements yet. Click "Add Achievement" to highlight school accomplishments.</p>
        ) : (
            ...
            {data.achievements.map((a, idx) => (
              <div key={idx} className="p-4 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-800 space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <button onClick={() => removeAchievement(idx)} className="p-1.5 text-slate-600 dark:text-slate-500 hover:text-rose-400 hover:bg-rose-500/10 rounded-lg transition-colors"><Trash2 className="w-4 h-4" /></button>
                </div>
